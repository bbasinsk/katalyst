...
public fun <A1, A2, A3, A4, A5, A6, A7, A8> tupleOf(
  a1: A1,
  a2: A2,
  a3: A3,
  a4: A4,
  ...
  a7: A7,
  a8: A8,
): Pair<Pair<Pair<Pair<Pair<Pair<Pair<A1, A2>, A3>, A4>, A5>, A6>, A7>, A8> = Pair(Pair(Pair(Pair(Pair(Pair(Pair(a1, a2), a3), a4), a5), a6), a7), a8)
