...
public fun <A1, A2, A3, A4, A5, A6, A7, A8, A9> tupleOf(
  ...
  a8: A8,
  a9: A9,
): Pair<Pair<Pair<Pair<Pair<Pair<Pair<Pair<A1, A2>, A3>, A4>, A5>, A6>, A7>, A8>, A9> = Pair(Pair(Pair(Pair(Pair(Pair(Pair(Pair(a1, a2), a3), a4), a5), a6), a7), a8), a9)
